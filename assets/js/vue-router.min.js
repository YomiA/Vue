...
t = this, e = function () {
    ...
    var n = {
        name: "RouterView", functional: !0, props: {name: {type: String, default: "default"}}, render: function (t, e) {
            var n = e.props, i = e.children, a = e.parent, c = e.data;
            c.routerView = !0;
            for (var u = a.$createElement, s = n.name, p = a.$route, f = a._routerViewCache || (a._routerViewCache = {}), h = 0, l = !1; a && a._routerRoot !== a;) {
            ...
            if (c.routerViewDepth = h, l) {
                var v = f[s], y = v && v.component;
                return y ? (v.configProps && o(y, c, v.route, v.configProps), u(y, c, i)) : u()
            }
            var m = p.matched[h], g = m && m.components[s];
            if (!m || !g) return f[s] = null, u();
            f[s] = {component: g}, c.registerRouteInstance = function (t, e) {
                var r = m.instances[s];
            ...
            return b && (r(f[s], {route: p, configProps: b}), o(g, c, p, b)), u(g, c, i)
        }
    };
    ...
    function p(t) {
        ...
        return (t = t.trim().replace(/^(\?|#|&)/, "")) ? (t.split("&").forEach(function (t) {
            var r = t.replace(/\+/g, " ").split("="), n = s(r.shift()), o = r.length > 0 ? s(r.join("=")) : null;
    ...
    function g(t, e) {
        return e === v ? t === e : !!e && (t.path && e.path ? t.path.replace(h, "") === e.path.replace(h, "") && t.hash === e.hash && b(t.query, e.query) : !(!t.name || !e.name) && t.name === e.name && t.hash === e.hash && b(t.query, e.query) && b(t.params, e.params))
    }
    ...
    function b(t, e) {
        ...
        return r.length === n.length && r.every(function (r) {
            var n = t[r], o = e[r];
            return "object" == typeof n && "object" == typeof o ? b(n, o) : String(n) === String(o)
        })
    }
    ...
    var k = Array.isArray || function (t) {
        ...
        }, R = I, E = C, O = function (t, e) {
            return $(C(t, e))
        }, _ = $, A = U,
        j = new RegExp(["(\\\\.)", "([\\/.])?(?:(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?|(\\*))"].join("|"), "g");

    function C(t, e) {
        for (var r, n = [], o = 0, i = 0, a = "", c = e && e.delimiter || "/"; null != (r = j.exec(t));) {
    ...
    function $(t) {
        ...
        return function (r, n) {
            for (var o = "", i = r || {}, a = (n || {}).pretty ? S : encodeURIComponent, c = 0; c < t.length; c++) {
                var u = t[c];
                if ("string" != typeof u) {
                    var s, p = i[u.name];
                    if (null == p) {
    ...
    function U(t, e, r) {
        ...
        for (var n = (r = r || {}).strict, o = !1 !== r.end, i = "", a = 0; a < t.length; a++) {
            var c = t[a];
            if ("string" == typeof c) i += T(c); else {
                var u = T(c.prefix), s = "(?:" + c.pattern + ")";
                e.push(c), c.repeat && (s += "(?:" + u + s + ")*"), i += s = c.optional ? c.partial ? u + "(" + s + ")?" : "(?:" + u + "(" + s + "))?" : u + "(" + s + ")"
            }
        }
        var p = T(r.delimiter || "/"), f = i.slice(-p.length) === p;
        return n || (i = (f ? i.slice(0, -p.length) : i) + "(?:" + p + "(?=$))?"), i += o ? "$" : n && f ? "" : "(?=" + p + "|$)", L(new RegExp("^" + i, q(r)), e)
    }
    ...
    function B(t, e, n, o) {
        ...
        if (!i.path && i.params && e) {
            ...
            if (e.name) i.name = e.name, i.params = c; else if (e.matched.length) {
        ...
        var s = function (t) {
        ...
        }(i.path || ""), f = e && e.path || "/", h = s.path ? w(s.path, f, n || i.append) : f, l = function (t, e, r) {
            void 0 === e && (e = {});
            var n, o = r || p;
            try {
                n = o(t || "")
            ...
            return n
        }(s.query, i.query, o && o.options.parseQuery), d = i.hash || s.hash;
        return d && "#" !== d.charAt(0) && (d = "#" + d), {_normalized: !0, path: h, query: l, hash: d}
    }

    var H, z = [String, Object], D = [String, Array], F = function () {
    }, N = {
        name: "RouterLink",
        props: {
        ...
        render: function (t) {
            var e = this, n = this.$router, o = this.$route, i = n.resolve(this.to, o, this.append), a = i.location,
                c = i.route, u = i.href, s = {}, p = n.options.linkActiveClass, f = n.options.linkExactActiveClass,
                d = null == p ? "router-link-active" : p, v = null == f ? "router-link-exact-active" : f,
                y = null == this.activeClass ? d : this.activeClass,
                m = null == this.exactActiveClass ? v : this.exactActiveClass,
                b = c.redirectedFrom ? l(null, B(c.redirectedFrom), null, n) : c;
            s[m] = g(o, b), s[y] = this.exact ? s[m] : function (t, e) {
    ...
    function Y(t, e) {
        var r = Q(t), n = r.pathList, o = r.pathMap, i = r.nameMap;

        function a(t, r, a) {
            var c = B(t, r, !1, e), s = c.name;
            if (s) {
                var p = i[s];
        ...
        function c(t, r) {
            var n = t.redirect, o = "function" == typeof n ? n(l(t, r, null, e)) : n;
            if ("string" == typeof o && (o = {path: o}), !o || "object" != typeof o) return u(null, r);
            var c = o, s = c.name, p = c.path, f = r.query, h = r.hash, d = r.params;
            return f = c.hasOwnProperty("query") ? c.query : f, h = c.hasOwnProperty("hash") ? c.hash : h, d = c.hasOwnProperty("params") ? c.params : d, s ? (i[s], a({
                _normalized: !0,
                name: s,
                query: f,
                hash: h,
                ...
                _normalized: !0, path: V(function (t, e) {
                    return w(t, e.parent ? e.parent.path : "/", !0)
                }(p, t), d), query: f, hash: h
            }, void 0, r) : u(null, r)
        }
    ...
    function ot() {
        ...
        n.key = et(), window.history.replaceState(n, "", e), window.addEventListener("popstate", function (t) {
    ...
    var ht,
        lt = J && (-1 === (ht = window.navigator.userAgent).indexOf("Android 2.") && -1 === ht.indexOf("Android 4.0") || -1 === ht.indexOf("Mobile Safari") || -1 !== ht.indexOf("Chrome") || -1 !== ht.indexOf("Windows Phone")) && window.history && "pushState" in window.history;
        ...
        return function (r, n, o) {
            ...
            gt(e, function (e, r, n, u) {
                if ("function" == typeof e && void 0 === e.cid) {
                    i = !0, a++;
                    var s, p = xt(function (t) {
                        var r;
                        ((r = t).__esModule || wt && "Module" === r[Symbol.toStringTag]) && (t = t.default), e.resolved = "function" == typeof t ? t : H.extend(t), n.components[u] = t, --a <= 0 && o()
                    }), f = xt(function (e) {
    ...
    Rt.prototype.listen = function (t) {
        ...
        var i = this, a = this.current, c = function (r) {
            !e(kt, r) && t(r) && (i.errorCbs.length ? i.errorCbs.forEach(function (t) {
                t(r)
    ...
    var _t = function (t) {
        function e(e, r) {
            var n = this;
            t.call(this, e, r);
            var o = e.options.scrollBehavior, i = lt && o;
            i && ot();
            var a = At(this.base);
            window.addEventListener("popstate", function (t) {
                var r = n.current, o = At(n.base);
                n.current === v && o === a || n.transitionTo(o, function (t) {
                    i && it(e, t, r, !0)
                })
            })
        }
    ...
    var jt = function (t) {
        ...
        return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.setupListeners = function () {
            var t = this, e = this.router.options.scrollBehavior, r = lt && e;
            r && ot(), window.addEventListener(lt ? "popstate" : "hashchange", function () {
                var e = t.current;
                Ct() && t.transitionTo(St(), function (n) {
    ...
    var Lt = function (t) {
        ...
        var e = t.mode || "hash";
        switch (this.fallback = "history" === e && !lt && !1 !== t.fallback, this.fallback && (e = "hash"), J || (e = "abstract"), this.mode = e, e) {
            case"history":
    ...
    return qt.prototype.match = function (t, e, r) {
        ...
        if (this.apps.push(t), t.$once("hook:destroyed", function () {
            ...
            this.app = t;
            var r = this.history;
            if (r instanceof _t) r.transitionTo(r.getCurrentLocation()); else if (r instanceof jt) {
                var n = function () {
                    r.setupListeners()
                };
        ...
        var n = B(t, e = e || this.history.current, r, this), o = this.match(n, e), i = o.redirectedFrom || o.fullPath;
        return {
        ...
        if (!t.installed || H !== e) {
            ...
            }), e.component("RouterView", n), e.component("RouterLink", N);
            var i = e.config.optionMergeStrategies;
            i.beforeRouteEnter = i.beforeRouteLeave = i.beforeRouteUpdate = i.created
        }
    }, qt.version = "3.1.6", J && window.Vue && window.Vue.use(qt), qt
